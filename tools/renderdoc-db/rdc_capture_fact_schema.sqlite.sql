...
DROP TABLE IF EXISTS event_unity_object;
DROP TABLE IF EXISTS event_gpu_counter;
DROP TABLE IF EXISTS event_pipeline_state;
DROP TABLE IF EXISTS event_resource_usage;
DROP TABLE IF EXISTS gpu_resource;
DROP TABLE IF EXISTS frame_event;
DROP TABLE IF EXISTS capture_file;
