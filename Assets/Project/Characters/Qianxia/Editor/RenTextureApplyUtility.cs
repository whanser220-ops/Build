...
public static class RenTextureApplyUtility
{
    ...
    private const string DiffuseTexturePath = "Assets/Project/Characters/Qianxia/Reference/Walking1/ExtractedTextures/Ch36_1001_Diffuse.png";
    private const string MaterialFolderPath = "Assets/Project/Characters/Qianxia/Reference/Ren/Materials";
    ...
    public static void ApplyWalkingTextureToRen()
    {
        ...
        if (diffuseTexture == null)
            throw new InvalidOperationException($"未找到贴图资源: {DiffuseTexturePath}");

        Shader shader = Shader.Find("Universal Render Pipeline/Lit");
        if (shader == null)
            throw new InvalidOperationException("未找到 URP/Lit Shader。");
