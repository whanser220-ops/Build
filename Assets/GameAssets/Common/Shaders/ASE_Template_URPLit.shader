Shader /*ase_name*/ "Hidden/ANGRYMESH/URPLit" /*end*/
{
	Properties
	{
		/*ase_props*/
	...
	SubShader
	{
		/*ase_subshader_options:Name=Additional Options
			...
			Option:LOD CrossFade:false,true:true
				...
				true:SetDefine:DepthOnly:pragma multi_compile_ LOD_FADE_CROSSFADE
				true:SetDefine:DepthNormals:pragma multi_compile_ _ LOD_FADE_CROSSFADE
				false:RemoveDefine:Forward:pragma multi_compile_ _ LOD_FADE_CROSSFADE
				false:RemoveDefine:GBuffer:pragma multi_compile_ _ LOD_FADE_CROSSFADE
				false:RemoveDefine:ShadowCaster:pragma multi_compile_ _ LOD_FADE_CROSSFADE
				false:RemoveDefine:DepthOnly:pragma multi_compile_ _ LOD_FADE_CROSSFADE
				false:RemoveDefine:DepthNormals:pragma multi_compile_ _ LOD_FADE_CROSSFADE
