...
| `get_gpu_passes` | GPU pass の event id、timing、shader、dispatch、resource binding をコンパクトに取得 |
...
get_gpu_passes(
    marker_filter="Crowd.",
    exclude_markers=["GUI.Repaint", "UIR.DrawChain"],
...
# → {"version": 1, "gpu": {"passes": [{"name": "...", "event_id": 123, "dispatch": [x, y, z], ...}]}}
```
